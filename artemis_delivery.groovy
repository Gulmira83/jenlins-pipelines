node {
    ...
    stage("Tag Image"){
		timestamps {
			ws {
				sh '''
                    docker tag artemis:latest 679745294409.dkr.ecr.us-east-2.amazonaws.com/artemis:${Version}
                    '''
				}
			}
		}
    stage("Push Image"){
	    timestamps {
			ws {
				sh '''
					docker push 965334959964.dkr.ecr.us-east-2.amazonaws.com/artemis:${Version}
					'''
				}
			}
		}
